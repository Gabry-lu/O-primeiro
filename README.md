...
Gabrielly: Foi responsável por toda a parte de desenvolvimento do código do projeto, atuando diretamente na criação da estrutura do site e na implementação das funcionalidades. Trabalhou na construção do HTML, estilização com CSS e, quando necessário, na programação com JavaScript para garantir o funcionamento correto das interações e páginas do sistema. Também realizou ajustes de layout, organização dos arquivos e correção de erros que surgiram durante o desenvolvimento, garantindo que o site ficasse responsivo e visualmente adequado ao tema proposto.

Bernado: Ficou responsável pela elaboração de toda a documentação do projeto, organizando as informações de forma clara e estruturada. Produziu os textos descritivos sobre o sistema, objetivos, justificativa, funcionalidades e etapas de desenvolvimento. Também auxiliou na formatação do conteúdo escrito, garantindo que a documentação seguisse uma apresentação adequada e coerente com o projeto. Além disso, contribuiu para o registro das decisões tomadas ao longo do desenvolvimento, ajudando a manter o histórico e a organização do trabalho.
